...
var CallManager = /*#__PURE__*/function () {
  ...
  _proto.addVideoStream = function addVideoStream(username, stream, isCurrentUser) {
    ...
    _util_BrowserUtil__WEBPACK_IMPORTED_MODULE_2__["default"].addRemoveClasses(videoCardHolder, 'col-sm-12 col-md-4 col-lg-3');
    ...
    _util_BrowserUtil__WEBPACK_IMPORTED_MODULE_2__["default"].addRemoveClasses(videoCardBody, 'card-body p-0');
    ...
    video.addEventListener("loadedmetadata", function () {
      video.play();
      if (_this2.webrtcDiv) _this2.webrtcDiv.append(videoCardHolder);
    });
  };

  _proto.callUser = function callUser(userId) {
    var _this3 = this; // wait a small time for the sockets and peer to sync


    var interval = setTimeout(function () {
      callLogger("Calling user " + userId);

      if (_this3.myVideoStream) {
        var call = _this3.peer.call(userId, _this3.myVideoStream);
